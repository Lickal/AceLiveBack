...
@NamedQueries({
    ...
    @NamedQuery(name = "Groupxusers.findByUserName", query = "SELECT g FROM Groupxusers g WHERE g.groupxusersPK.userName = :userName"),
...
public class Groupxusers implements Serializable {
    ...
    public Groupxusers(int groupId, String userName) {
        this.groupxusersPK = new GroupxusersPK(groupId, userName);
    }
