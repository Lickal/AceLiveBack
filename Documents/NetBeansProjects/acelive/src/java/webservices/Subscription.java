...
@NamedQueries({
    ...
    @NamedQuery(name = "Subscription.findByUserName", query = "SELECT s FROM Subscription s WHERE s.subscriptionPK.userName = :userName"),
...
public class Subscription implements Serializable {
    ...
    public Subscription(String userName, int newsletterId) {
        this.subscriptionPK = new SubscriptionPK(userName, newsletterId);
    }
